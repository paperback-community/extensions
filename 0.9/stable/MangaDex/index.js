...
var source = (() => {
  ...
  var MangaDexSettingsForm = class extends import_types2.Form {
    languagesState = new State3(
      this,
      "languages",
      getLanguages()
    );
    ratingsState = new State3(this, "ratings", getRatings());
    dataSaverState = new State3(
      this,
      "data_saver",
      getDataSaver()
    );
    skipSameChapterState = new State3(
      this,
      "skip_same_chapter",
      getSkipSameChapter()
    );
    forcePortState = new State3(
      this,
      "force_port_443",
      getForcePort443()
    );
    oAuthState = new State3(
      this,
      "oauth_state",
      !!getAccessToken()
    );
    homepageThumbState = new State3(
      this,
      "homepage_thumbnail",
      getHomepageThumbnail()
    );
    searchThumbState = new State3(
      this,
      "search_thumbnail",
      getSearchThumbnail()
    );
    mangaThumbState = new State3(
      this,
      "manga_thumbnail",
      getMangaThumbnail()
    );
    resetState = new State3(this, "reset_trigger", false);
    blockedGroupsState = new State3(this, "blocked_groups", getBlockedGroups());
    getSections() {
      return [
    ...
    createOAuthSection() {
      return (0, import_types2.Section)("oAuthSection", [
        ...
        (0, import_types2.NavigationRow)("mangadex_status", {
    ...
    createStatusSection() {
      return (0, import_types2.Section)("status_section", [
        (0, import_types2.NavigationRow)("mangadex_status", {
          title: "MangaDex Status",
          form: this.createStatusInfoForm()
        })
    ...
    createSessionInfoForm() {
      return new class SessionInfoForm extends import_types2.Form {
        ...
        getSections() {
          if (!this.sessionState) {
            return [
              (0, import_types2.Section)("session_status", [
                (0, import_types2.LabelRow)("status", {
                  title: "Status",
          ...
          if (!accessToken) {
            return [
              (0, import_types2.Section)("introspect", [
                (0, import_types2.LabelRow)("logged_out", { title: "LOGGED OUT" })
              ])
            ];
          }
          return [
            (0, import_types2.Section)(
              ...
              Object.entries(accessToken.tokenBody).map(
                ([key, value]) => (0, import_types2.LabelRow)(key, {
                  title: key,
                  value: String(value)
                })
              )
            ),
            (0, import_types2.Section)("account_actions", [
              (0, import_types2.ButtonRow)("refresh_token_button", {
                title: "Refresh Token",
    ...
    createContentSettingsSection() {
      return (0, import_types2.Section)("contentSettings", [
        ...
        (0, import_types2.NavigationRow)("group_block_manager", {
    ...
    createGroupBlockForm() {
      return new class GroupBlockForm extends import_types2.Form {
        constructor(outerForm) {
          super();
          this.outerForm = outerForm;
          this.parentForm = outerForm;
        ...
        groupsToUnblock = [];
        totalResultsCount = 0;
        groupBlockingEnabledState = new State3(
          this,
        ...
        getSections() {
          ...
          return [
            (0, import_types2.Section)("group_blocking_settings", [
              (0, import_types2.ToggleRow)("group_blocking_enabled", {
            ...
            (0, import_types2.Section)(
              ...
              [
                (0, import_types2.InputRow)("search_input", {
                ...
                (0, import_types2.ButtonRow)("clear_button", {
                  title: "Clear Search",
                  onSelect: Application.Selector(
                    this,
                    "handleClearSearch"
                ...
                (0, import_types2.LabelRow)("search_results_info", {
                  title: "Results",
                ...
                (0, import_types2.LabelRow)("no_results", {
                  title: "No results found",
                  isHidden: !(this.hasSearched && showNoResults)
                }),
                (0, import_types2.LabelRow)("loading", {
                  title: "Loading results...",
                  isHidden: !(this.isLoading && !this.isPaginationLoading)
                }),
                (0, import_types2.SelectRow)("search_results", {
            ...
            (0, import_types2.Section)("pagination", [
              (0, import_types2.ButtonRow)("next_page", {
                title: "Next Page",
                onSelect: Application.Selector(
                  this,
                  "handleNextPage"
              ...
              (0, import_types2.ButtonRow)("prev_page", {
                title: "Previous Page",
                onSelect: Application.Selector(
                  this,
                  "handlePrevPage"
            ...
            (0, import_types2.Section)("reset_group_blocks", [
              (0, import_types2.ButtonRow)("reset_group_blocks", {
        ...
        async fetchGroups(offset, isPagination = false) {
          ...
          this.reloadForm();
          try {
            const url = new URLBuilder("https://api.mangadex.org").addPath("group").addQuery("limit", GROUP_SEARCH_PAGE_SIZE).addQuery("offset", offset);
    ...
    createThumbnailSettingsSection() {
      return (0, import_types2.Section)("thumbnail_settings", [
        (0, import_types2.SelectRow)("homepage_thumbnail", {
        ...
        (0, import_types2.SelectRow)("search_thumbnail", {
        ...
        (0, import_types2.SelectRow)("manga_thumbnail", {
    ...
    createStatusInfoForm() {
      return new class StatusInfoForm extends import_types2.Form {
        statusData;
        constructor() {
          super();
          this.statusData = {
        ...
        getSections() {
          return [
            (0, import_types2.Section)(
              "status_info",
              this.statusData.content.map(
                (text3, index2) => (0, import_types2.LabelRow)(`status_${index2}`, {
                  title: index2 === 0 && this.statusData.loading ? "Loading..." : text3
                })
              )
            ),
            (0, import_types2.Section)("status_actions", [
              (0, import_types2.ButtonRow)("refresh_status", {
        ...
        async fetchStatusInfo() {
          try {
            ...
            const content = [];
            const wrapText = (text3, maxLength = 45) => {
              const lines = [];
              const paragraphs = text3.split(/(?:<br\s*\/?>|\n)+/);
            ...
            if (unresolvedIncidents.length) {
              unresolvedIncidents.each((_, incident) => {
                ...
                $2(incident).find(".update").each((_2, update2) => {
    ...
    createResetSection() {
      return (0, import_types2.Section)("reset_section", [
        (0, import_types2.ButtonRow)("reset_settings", {
  ...
  var contentRatingMap = {
    safe: import_types3.ContentRating.EVERYONE,
    suggestive: import_types3.ContentRating.MATURE,
    erotica: import_types3.ContentRating.ADULT,
    pornographic: import_types3.ContentRating.ADULT
  };
  ...
  var parseMangaDetails = (mangaId, COVER_BASE_URL2, json, ratingJson) => {
    ...
    let image = "";
    const coverFileName = json.data.relationships.filter(
      (x) => x.type.valueOf() === "cover_art"
    ).map((x) => x.attributes?.fileName)[0];
    if (coverFileName) {
    ...
    return {
      ...
      mangaInfo: {
        ...
        contentRating: contentRatingMap[mangaDetails.contentRating?.toLowerCase() ?? ""] ?? import_types3.ContentRating.EVERYONE,
  ...
  function parseChapterTitle(attributes2) {
    ...
    const volume = attributes2.volume ? `Vol. ${attributes2.volume} ` : "";
    const chapter = attributes2.chapter ? `Ch. ${attributes2.chapter}` : "";
  ...
  var MangaDexInterceptor = class extends import_types4.PaperbackInterceptor {
  ...
  var MangaDexExtension = class {
    ...
    async getChapters(sourceManga) {
      ...
      while (hasResults) {
        const request = {
          url: new URLBuilder(MANGADEX_API).addPath("manga").addPath(mangaId).addPath("feed").addQuery("limit", 500).addQuery("offset", offset).addQuery("includes", ["scanlation_group"]).addQuery(
            "excludedGroups",
            blockedGroups.length > 0 ? blockedGroups : []
          ).addQuery("translatedLanguage", languages).addQuery("order", {
            volume: "desc",
            chapter: "desc",
            publishAt: "desc"
    ...
    async getSearchResults(query, metadata) {
      ...
      for (const filter4 of query.filters) {
        ...
        if (filter4.id == "includeOperator") {
          url.addQuery("includedTagsMode", filter4.value ?? "and");
        }
        if (filter4.id == "excludeOperator") {
          url.addQuery("excludedTagsMode", filter4.value ?? "or");
        }
      }
      const request = {
