...
var source = (() => {
  ...
  var contentRatingMap = {
    safe: import_types2.ContentRating.EVERYONE,
    suggestive: import_types2.ContentRating.MATURE,
    erotica: import_types2.ContentRating.ADULT,
    pornographic: import_types2.ContentRating.ADULT
  };
  ...
  var parseMangaDetails = (mangaId, COVER_BASE_URL2, json, ratingJson) => {
    ...
    return {
      ...
      mangaInfo: {
        ...
        contentRating: contentRatingMap[mangaDetails.contentRating?.toLowerCase() ?? ""] ?? import_types2.ContentRating.EVERYONE,
